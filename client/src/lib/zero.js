...
export const isProxyApproved = async (tokenId) => {
  return erc721Wrapper.isProxyApprovedAsync(contractAddr, new BigNumber(tokenId))
}
...
//  console.log('order hash', orderHashHex)
  return signatureUtils.ecSignOrderAsync(providerEngine, order, maker);
