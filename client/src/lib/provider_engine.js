...
window.nifty.providerEngine = window.nifty.providerEngine || providerEngine;
window.nifty.userAddress = window.nifty.userAddress || userAddress;
...
window.niftyProvider = window.niftyProvider || startPromise.then(window.niftyProvider = { done: true})
