...
export const TX_DEFAULTS = { gas: 150000 };
...
export const NETWORK_CONFIGS = MAINNET_CONFIGS ; // or KOVAN_CONFIGS or ROPSTEN_CONFIGS or RINKEBY_CONFIGS or GANACHE_CONFIGS
